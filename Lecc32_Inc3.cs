internal class Program
{
    private static void Main(string[] args)
    {
        ...
        do
        {
            ...
            Console.Write("Escriba la medida del lado 1: ");
            double lado1 = Convert.ToDouble(Console.ReadLine());
            Console.Write("Escriba la medida del lado 2: ");
            double lado2 = Convert.ToDouble(Console.ReadLine());

            Console.Write("Escriba la medida del lado 3: ");
            ...
            {
                Console.WriteLine("Error: Las medidas Escritas no pueden formar un triángulo válido.");
            }
